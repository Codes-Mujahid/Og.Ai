...
import blogImageLicenseMigration from '../assets/images/blog/License_Migration.png';
import blogImageH2Update from '../assets/images/blog/H2_Update.png';
                    ...
                    <div id="w-node-_6eee297f-a733-3fc3-39a1-532cf9714a8f-680a4b03" class="width-100 w-dyn-list">
                        <div role="list" class="press-featured_component w-dyn-items">
                            <div role="listitem" class="press-vertical_item w-dyn-item">
                                <div class="border-line-wrap"><a href="/blog/alignment-node-license-migration" class="press-vertical_content-wrap w-inline-block"><img src="/assets/images/blog/License_Migration.png" loading="lazy" alt="" sizes="100vw" srcset="/assets/images/blog/License_Migration.png 500w, /assets/images/blog/License_Migration.png 800w, /assets/images/blog/License_Migration.png 1080w, /assets/images/blog/License_Migration.png 1147w" class="press-vertical_img"/><div class="press_title-wrapper mobile-gap-4"><div class="press_meta-wrapper"><div class="w-dyn-bind-empty"></div><div class="icon-embed-custom w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 4 4" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img"><circle cx="2" cy="2" r="2" fill="currentColor"/></svg></div><div>Dec 16, 2025</div></div><div class="spacer-xsmall"><h3 class="text-size-24 mobile-18">AI Alignment Node License Migration </h3></div></div></a></div>
                            </div>
                            <div role="listitem" class="press-vertical_item w-dyn-item">
                                <div class="border-line-wrap"><a href="/blog/0g-ecosystem-update-h22025" class="press-vertical_content-wrap w-inline-block"><img src="/assets/images/blog/H2_Update.png" loading="lazy" alt="" sizes="100vw" srcset="/assets/images/blog/H2_Update.png 500w, /assets/images/blog/H2_Update.png 800w, /assets/images/blog/H2_Update.png 1080w, /assets/images/blog/H2_Update.png 1147w" class="press-vertical_img"/><div class="press_title-wrapper mobile-gap-4"><div class="press_meta-wrapper"><div class="w-dyn-bind-empty"></div><div class="icon-embed-custom w-embed"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 4 4" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img"><circle cx="2" cy="2" r="2" fill="currentColor"/></svg></div><div>Dec 15, 2025</div></div><div class="spacer-xsmall"><h3 class="text-size-24 mobile-18">Building Infinite AI: H2 2025 0G Ecosystem Update</h3></div></div></a></div>
                            </div>
                        </div>
                    </div>
                    <div id="w-node-de258b64-d14a-d0af-18c8-66beed0c66eb-680a4b03" class="border-line-wrap">
